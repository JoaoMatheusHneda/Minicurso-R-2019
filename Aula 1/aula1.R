...
pesquisa[pesquisa$PESO > 50 & pesquisa$PESO < 70,]
subset(pesquisa, PESO > 50 & PESO < 70) # Seleciona as linhas com peso maior que 50 e menor que 70.

pesquisa[pesquisa$PESO > 50 & pesquisa$ALTURA < 1.70,]
subset(pesquisa, PESO > 50 & ALTURA < 1.70) # Seleciona as linhas com peso maior que 50 e altura menor que 1.70.
...
# Lista Nomeada
(lista <- list(Sequencia=1:10,
               Nomes=c("Maria", "João", "Alfredo"),
               NumAleat=rnorm(10),
               Dataframe=pesquisa))
...
dados_txt$emp <- as.factor(dados_txt$emp)
dados_txt$grp <- as.factor(dados_txt$grp)
...
## ------------------------------------------------------------------------
plot(dados_txt$x1 ~ dados_txt$grp)
