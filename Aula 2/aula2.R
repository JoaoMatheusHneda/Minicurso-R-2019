...
repeat {
  x = x + 2
  if (x > 30){
    print(paste0("Esse é o último número: ",x))
    break
  }
  print(x)
}
...
# X = É uma lista
# FUN = Função a ser aplicada em cada elemento da lista
# simplify = TRUE: Se Verdadeiro, o resultado será simplificado
